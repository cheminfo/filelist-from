 ...
 */
export type GroupFiles = (flist:PartialFileList | FileList, options: GroupFilesOptions) => GroupedFiles[]
/**
...
export const groupFiles: GroupFiles = ( fileList, options =  { idWithBasename: true, fileKey: "extension" }) => {
    const { 
      idWithBasename, 
      fileKey,
      applyToFileKey,
